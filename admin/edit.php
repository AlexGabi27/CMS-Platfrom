            ...
            <center><div class="card" style="width: 95%; height: 85%;">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="edit.php">Editare postare</a></li>
                        <li class="nav-item"><a class="nav-link" href="del.php">Stergere postare</a></li>
                    </ul>
                </div>
                <div class="card-body">
                    <h4 class="card-title">Editare articol nou</h4>
                    <?php if(isset($_SESSION['username'])) :?>
                        <iframe src="editare.php" style="width: 100%; height: 90%; border: none;"></iframe>
                    <?php endif ?>
                </div>
            </div></center>
        <?php else: ?>
